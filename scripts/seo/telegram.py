"""Telegram client for the SEO content agent.

Thin wrapper around the shared TelegramClient, using dedicated
SEO bot credentials loaded lazily from Secret Manager.
"""
...
def send_telegram_message(text):
    """Send a text message via the SEO Telegram bot. Returns True on success."""
...
def poll_for_callback(prefix="seo_", timeout_minutes=120, poll_interval=5,
