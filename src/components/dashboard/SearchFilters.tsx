    ...
    <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 space-y-4">
      ...
      <div className="relative">
        ...
        <Input
          ...
          className="pl-10 h-12 text-base border-slate-300 focus:border-[#2D5F3F] focus:ring-[#2D5F3F]"
        />
      </div>
        ...
        <div className="flex flex-wrap gap-2">
          {selectedSkills.map((skill) => (
            <Badge
              key={skill}
              variant="secondary"
              className="bg-green-100 text-[#2D5F3F] hover:bg-green-200 px-3 py-1 text-sm"
            >
              {skill}
              <button
                onClick={() => removeSkill(skill)}
                className="ml-2 hover:text-[#1a3a26]"
              >
                <X className="w-3 h-3" />
              </button>
            </Badge>
      ...
      {hasActiveFilters && (
        <div className="flex justify-end pt-2">
          <Button
            ...
            className="text-slate-600 hover:text-[#2D5F3F] hover:bg-green-50"
          >
