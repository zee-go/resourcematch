            ...
            return (
              ...
              >
                ...
                <div className="relative">
                  {/* Icon */}
                  <div className="inline-flex items-center justify-center w-14 h-14 rounded-xl bg-gradient-to-br from-[#2D5F3F] to-[#D97642] mb-6 group-hover:scale-110 transition-transform duration-300">
